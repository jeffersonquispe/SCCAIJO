...
Begin VB.Form frmCBConsulDiarioCaja 
   Caption         =   "SGCcaijo-Consulta Diario de Caja"
   ClientHeight    =   8595
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   HelpContextID   =   70
   Icon            =   "SCCBConsulDiarioCaja.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8595
   ScaleWidth      =   11880
   ...
   End
End
Attribute VB_Name = "frmCBConsulDiarioCaja"
...
' Clausula WHERE de las relaciones del rpt.
  ...
  If CDate(mskFechaIni.Text) < CDate("01/01/2007") Or CDate(mskFechaFin.Text) < CDate("01/01/2007") Then
    ' Nombre del fichero
    rptGastosProvDocDet.NombreRPT = "rptCBDiarioCajaAntiguo.rpt"
  Else
    ' Nombre del fichero
    rptGastosProvDocDet.NombreRPT = "rptCBDiarioCajaNuevo.rpt"
  End If
...
' Carga la sentencia
sSQL = "DELETE * FROM RPTCBCONSULSALDOINICIALDIARIOCAJA"
...
' Carga la sentencia
sSQL = "DELETE * FROM RPTCBCONSULDIARIOCAJADET"
...
' Fecha,TipDoc,NroDoc,Cta.Ctb.,Prov.Ejecutor,Detalle.Movimiento, _
  Ingreso , Egreso, Rendir, Orden, Var
    If grdConsulta.TextMatrix(i, 10) = "G" Then
      ...
      sSQL = "INSERT INTO RPTCBCONSULSALDOINICIALDIARIOCAJA VALUES('" _
    ...
    ElseIf grdConsulta.TextMatrix(i, 10) = "D" Then
      ...
      sSQL = "INSERT INTO RPTCBCONSULDIARIOCAJADET VALUES('" _
        & FechaAMD(grdConsulta.TextMatrix(i, 0)) & "','" _
...
' Fecha,TipDoc,NroDoc,Cta.Ctb.,Prov.Ejecutor,Detalle.Movimiento, _
  Ingreso , Egreso, Rendir, Orden, Var
aTamañosColumnas = Array(1000, 400, 1000, 800, 3000, 3000, 1200, 1200, 1200, 1100, 0)
...
For Each mFecha In mcolSaldoIni
    ...
    grdConsulta.AddItem FechaDMA(Var30(mFecha, 1)) & vbTab & vbTab & vbTab & vbTab & vbTab & _
   ...
   ' Coloca color al grid
    ...
    grdConsulta.AddItem "Fecha" & vbTab & "Doc" & vbTab & "Número" & vbTab & "Cod.Cta." _
                & vbTab & "Proveedor.Ejecutor" & vbTab & "Detalle.Movimiento" & vbTab _
                & "Ingreso" & vbTab & "Egreso" & vbTab & "Rendir" & vbTab & "Orden" & vbTab _
                & "Var"
   ' Coloca color al grid
    grdConsulta.Row = grdConsulta.Rows - 1
    MarcarFilaGRID grdConsulta, vbWhite, vbDarkGray
  ...
  Else ' El cursor tiene datos
   ...
   If mcurEgresos.campo(0) = mcurEgreMovRendir.campo(0) And _
      mcurEgresos.campo(1) = mcurEgreMovRendir.campo(1) Then
        ' muestra registro en le grid
         grdConsulta.AddItem FechaDMA(mcurEgreMovRendir.campo(0)) & vbTab _
                          & mcurEgresos.campo(2) & vbTab _
                          & mcurEgresos.campo(3) & vbTab _
                          & msCtaRendir & vbTab _
                          & mcurEgreMovRendir.campo(2) & vbTab _
                          & mcurEgreMovRendir.campo(3) & vbTab & vbTab _
      ...
      ElseIf mcurEgreMovTerc.campo(6) = "R" Then
        ' muestra registro en le grid
         grdConsulta.AddItem FechaDMA(mcurEgreMovTerc.campo(0)) & vbTab _
                          ...
                          & mcurEgreMovTerc.campo(2) & vbTab _
                          & mcurEgreMovTerc.campo(3) & vbTab _
                          & mcurEgreMovTerc.campo(4) & vbTab & vbTab & vbTab _
   ...
   If mcurEgresos.campo(0) = mcurEgreMovPers.campo(0) And _
      ...
      If mcurEgreMovPers.campo(6) = "C" Then
         ...
         grdConsulta.AddItem FechaDMA(mcurEgreMovPers.campo(0)) & vbTab _
                         ...
                         & mcurEgreMovPers.campo(4) & vbTab & vbTab _
       ...
       ElseIf mcurEgreMovPers.campo(6) = "R" Then
        ...
        grdConsulta.AddItem FechaDMA(mcurEgreMovPers.campo(0)) & vbTab _
                         ...
                         & mcurEgreMovPers.campo(2) & vbTab _
                         & mcurEgreMovPers.campo(3) & vbTab _
                         & mcurEgreMovPers.campo(4) & vbTab & vbTab & vbTab _
   ...
   If mcurEgresos.campo(0) = mcurEgrePlanll.campo(0) And _
      ...
      If mcurEgrePlanll.campo(6) = "C" Then
        ...
        grdConsulta.AddItem FechaDMA(mcurEgrePlanll.campo(0)) & vbTab _
                         ...
                         & mcurEgrePlanll.campo(4) & vbTab & vbTab _
      ...
      ElseIf mcurEgrePlanll.campo(6) = "R" Then
        ...
        grdConsulta.AddItem FechaDMA(mcurEgrePlanll.campo(0)) & vbTab _
                         ...
                         & mcurEgrePlanll.campo(2) & vbTab _
                         & mcurEgrePlanll.campo(3) & vbTab _
                         & mcurEgrePlanll.campo(4) & vbTab & vbTab & vbTab _
   ...
   If mcurEgresos.campo(0) = mcurEgrePrest.campo(0) And _
      ...
      If mcurEgrePrest.campo(6) = "C" Then
        ...
        grdConsulta.AddItem FechaDMA(mcurEgrePrest.campo(0)) & vbTab _
                         ...
                         & mcurEgrePrest.campo(4) & vbTab & vbTab _
      ...
      ElseIf mcurEgrePrest.campo(6) = "R" Then
        ...
        grdConsulta.AddItem FechaDMA(mcurEgreAdelt.campo(0)) & vbTab _
                    ...
                    & mcurEgreAdelt.campo(4) & vbTab & vbTab & vbTab _
   ...
   If mcurEgresos.campo(0) = mcurEgreAdelt.campo(0) And _
      ...
      If mcurEgreAdelt.campo(6) = "C" Then
        ...
        grdConsulta.AddItem FechaDMA(mcurEgreAdelt.campo(0)) & vbTab _
                    ...
                    & mcurEgreAdelt.campo(2) & vbTab _
                    & mcurEgreAdelt.campo(3) & vbTab _
                    & mcurEgreAdelt.campo(4) & vbTab & vbTab _
      ...
      If mcurEgreCAIngrImptRet.campo(6) = "C" Then
        If (LTrim(RTrim(mcurEgreCAIngrImptRet.campo(4))) = LTrim(RTrim("IMPUESTO GENERAL DE LAS VENTAS (IGV) 18%"))) And ((mcurEgreCAIngrImptRet.campo(7) = "01") Or (mcurEgreCAIngrImptRet.campo(7) = "12") Or (mcurEgreCAIngrImptRet.campo(7) = "13")) Then
          ...
          grdConsulta.AddItem FechaDMA(mcurEgreCAIngrImptRet.campo(0)) & vbTab _
                    ...
                    & mcurEgreCAIngrImptRet.campo(4) & vbTab & vbTab _
      ...
      ElseIf mcurEgreCAIngrImptRet.campo(6) = "R" Then
        ...
        Else
          ...
          grdConsulta.AddItem FechaDMA(mcurEgreCAIngrImptRet.campo(0)) & vbTab _
                    ...
                    & mcurEgreCAIngrImptRet.campo(2) & vbTab _
                    & mcurEgreCAIngrImptRet.campo(3) & vbTab _
                    & mcurEgreCAIngrImptRet.campo(4) & vbTab & vbTab & vbTab _
   ...
   If mcurEgresos.campo(0) = mcurEgreCAServ.campo(0) And _
    ...
    If mcurEgreCAServ.campo(6) = "C" Then
        ...
        grdConsulta.AddItem FechaDMA(mcurEgreCAServ.campo(0)) & vbTab _
                         ...
                         & mcurEgreCAServ.campo(4) & vbTab & vbTab _
    ...
    ElseIf mcurEgreCAServ.campo(6) = "R" Then
        ...
        grdConsulta.AddItem FechaDMA(mcurEgreCAServ.campo(0)) & vbTab _
                         ...
                         & mcurEgreCAServ.campo(2) & vbTab _
                         & mcurEgreCAServ.campo(3) & vbTab _
                         & mcurEgreCAServ.campo(4) & vbTab & vbTab & vbTab _
   ...
   If mcurEgresos.campo(0) = mcurEgreCAProd.campo(0) And _
     ...
     ElseIf mcurEgreCAProd.campo(6) = "R" Then
        ...
        grdConsulta.AddItem FechaDMA(mcurEgreCAProd.campo(0)) & vbTab _
                         ...
                         & mcurEgreCAProd.campo(2) & vbTab _
                         & mcurEgreCAProd.campo(3) & vbTab _
                         & mcurEgreCAProd.campo(4) & vbTab & vbTab & vbTab _
  ...
  Else ' El cursor tiene datos
   ...
   If mcurIngresos.campo(0) = mcurIngrAnulados.campo(0) And _
     ...
     grdConsulta.AddItem FechaDMA(mcurIngrAnulados.campo(0)) & vbTab _
                      & mcurIngresos.campo(2) & vbTab _
                      & mcurIngresos.campo(3) & vbTab & vbTab _
                      & "ANULADO" & vbTab _
                      & "ANULADO" & vbTab _
 ...
 Do While brecorre = True
  ...
  Else ' El cursor tiene datos
   ...
   If mcurIngresos.campo(0) = mcurIngrMovRendir.campo(0) And _
     ...
     ' muestra registro en le grid
     grdConsulta.AddItem FechaDMA(mcurIngrMovRendir.campo(0)) & vbTab _
                      & mcurIngresos.campo(2) & vbTab _
                      & mcurIngresos.campo(3) & vbTab _
                      & msCtaRendir & vbTab _
                      & mcurIngrMovRendir.campo(2) & vbTab _
  ...
  Else ' El cursor tiene datos
   ...
   If mcurIngresos.campo(0) = mcurIngrTraslado.campo(0) And _
     ...
     grdConsulta.AddItem FechaDMA(mcurIngrTraslado.campo(0)) & vbTab _
                      ...
                      & mcurIngresos.campo(3) & vbTab _
                      & sCodCta & vbTab _
                      & mcurIngrTraslado.campo(4) & vbTab _
