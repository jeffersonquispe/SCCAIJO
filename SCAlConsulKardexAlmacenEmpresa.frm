...
Begin VB.Form frmAlConsulKardexAlmacenEmpresa 
   Caption         =   "Consulta de kardex de almacén                              -----  EMPRESAS  -----"
   ClientHeight    =   6900
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11880
   HelpContextID   =   95
   Icon            =   "SCAlConsulKardexAlmacenEmpresa.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   6900
   ScaleWidth      =   11880
   ...
   Begin VB.CommandButton cmdPProducto 
      Height          =   255
      Left            =   6810
      Picture         =   "SCAlConsulKardexAlmacenEmpresa.frx":08CA
      Style           =   1  'Graphical
      TabIndex        =   1
      TabStop         =   0   'False
      Top             =   510
   ...
   End
End
Attribute VB_Name = "frmAlConsulKardexAlmacenEmpresa"
